...
using EcosferaBlazor.Auth.Application.Features.Loggers.Caching;
using EcosferaBlazor.Auth.Application.Features.Loggers.DTOs;
using EcosferaBlazor.Auth.Application.Features.Loggers.Specifications;
using EcosferaBlazor.Auth.Domain.Entities.Logger;

namespace EcosferaBlazor.Auth.Application.Features.Loggers.Queries.PaginationQuery;
