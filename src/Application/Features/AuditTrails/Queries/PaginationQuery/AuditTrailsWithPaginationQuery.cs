...
using EcosferaBlazor.Auth.Application.Features.AuditTrails.Caching;
using EcosferaBlazor.Auth.Application.Features.AuditTrails.DTOs;
using EcosferaBlazor.Auth.Application.Features.AuditTrails.Specifications;

namespace EcosferaBlazor.Auth.Application.Features.AuditTrails.Queries.PaginationQuery;
